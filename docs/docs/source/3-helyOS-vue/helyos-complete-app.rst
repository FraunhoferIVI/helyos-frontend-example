                ...
                <li>
                    ...
                    <div id="geojson-bar">
                        ...
                        <button class="custom-btn" id="push-geojson-btn" @click="pushGeoJson"
                            @mouseenter="hintMsg = 'helyosService.mapObjects.create(shape: Partial<H_MapObject>): Promise<any>'"
                            @mouseleave="hintMsg = 'HelyOS'">Push</button>
                        <button class="custom-btn" id="delete-geojson-btn" @click="deleteGeoJson"
                            @mouseenter="hintMsg = 'helyosService.mapObjects.delete(shapeId: any): Promise<any>'"
